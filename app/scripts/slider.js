...
(function (a) {
  ...
  var y = '1.6.15',
    ...
    var G = f(this),
      ...
      if (F && (typeof H === 'undefined' ? 'undefined' : _typeof(H)) === 'object') {
    ...
    var au = f.extend({}, au);var az = a || d || !au.fallbackToMouseEvents,
      ...
      if ((typeof bd === 'undefined' ? 'undefined' : _typeof(bd)) === 'object') {
        au = f.extend(au, bd);
      } else {
        if (au[bd] !== undefined) {
          if (bc === undefined) {
  ...
  n.fn.bsTouchSlider = function (i) {
    var a = n('.carousel');return this.each(function () {
      function i(i) {
        var a = 'webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend';i.each(function () {
          var i = n(this),
              t = i.data('animation');i.addClass(t).one(a, function () {
            i.removeClass(t);
          });
        });
      ...
      }), n('.carousel .carousel-inner').swipe({ swipeLeft: function swipeLeft(n, i, a, t, e) {
